...
def insert_itviec_jobs(jobs):
    ...
    query = text("""
        INSERT INTO job_db_sm4x.bronze.itviec_data_job (title, company, logo, url, location, mode, tags, descriptions, requirements, posted_to_discord)
...
def insert_topcv_jobs(jobs):
    ...
    query = text("""
        INSERT INTO job_db_sm4x.bronze.topcv_data_job (title, company, logo, url, location, salary, descriptions, requirements, experience, education, type_of_work, posted_to_discord)
